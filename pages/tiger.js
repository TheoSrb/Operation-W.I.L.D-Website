const ENTITY_ID = "tiger";

const ANIMAL_TAMING_EXP = 185.0;
const MAX_HEALTH = 35;
const DAMAGES = 8;
const KNOCKBACK_RESISTANCE = 0.4;
const SPEED = 8.4;

const ARCHETYPE = "ASSASSIN";
const REGIME = "Carnivore";

const ANIMAL_PAGE_AVG_COLOR = "#d97733";

const HERO_WALLPAPER = "../src/assets/animals_wallpapers/Tiger-Wallpaper.png";
const HERO_WALLPAPER_OFFSET_Y = 50;
const PORTRAITS = [
    "../src/assets/pages/tiger/tiger_0.png",
    "../src/assets/pages/tiger/tiger_1.png",
    "../src/assets/pages/tiger/tiger_2.png",
    "../src/assets/pages/tiger/tiger_3.png"
];
const DIFFICULTY_ICON = "../src/assets/pages/difficulty-icon/difficulty_4.png";
...
const VARIANTS = [
    { img: "../src/assets/pages/tiger/tiger_0.png", nom: "Tigre par Défaut", badge: "Commun", badgeStyle: "background:rgba(168,176,144,.2);color:var(--text2);border:1px solid rgba(168,176,144,.3)", taux: "60%" },
    { img: "../src/assets/pages/tiger/tiger_1.png", nom: "Tigre Clair", badge: "Peu Commun", badgeStyle: "background:rgba(58,122,60,.2);color:var(--green2);border:1px solid rgba(58,122,60,.4)", taux: "25%" },
    { img: "../src/assets/pages/tiger/tiger_2.png", nom: "Tigre Doré", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "12%" },
    { img: "../src/assets/pages/tiger/tiger_3.png", nom: "Tigre Blanc", badge: "Légendaire", badgeStyle: "background:rgba(212,100,26,.2);color:var(--orange2);border:1px solid rgba(212,100,26,.4)", taux: "3%" }
];

const ANIMATIONS = [
    { label: "Idle", src: "../src/assets/pages/tiger/anim_0.gif" },
    { label: "Marche", src: "../src/assets/pages/tiger/anim_1.gif" },
    { label: "Course", src: "../src/assets/pages/tiger/anim_2.gif" },
    { label: "Hurlement", src: "../src/assets/pages/tiger/anim_3.gif" }
];
...
const SPAWN_RARITY_MAP = { "jungle": "Rare" };

const SIMILAR_ANIMALS = ["lion", "kodiak", "crocodile"];
...
const COSMETICS = [
    { id: "skin_default", nom: "Tenue par Défaut", rarete: "Commun", img: "../src/assets/pages/tiger/tiger_0.png", desc: "La tenue de base du Tigre.", equipped: true },
    { id: "skin_gold", nom: "Tenue Dorée", rarete: "Légendaire", img: "../src/assets/pages/tiger/skin_0.png", desc: "La tenue dorée du Tigre.", equipped: false },
    { id: "skin_virus", nom: "Tenue Virus", rarete: "Légendaire", img: "../src/assets/pages/tiger/skin_2.png", desc: "La tenue de Virus du Tigre.", equipped: false },
    { id: "skin_pizza", nom: "Tenue Pizzaiolo", rarete: "Épique", img: "../src/assets/pages/tiger/skin_1.png", desc: "La tenue de Pizzaiolo du Tigre.", equipped: false },
    { id: "skin_boss", nom: "Tenue Parrain", rarete: "Rare", img: "../src/assets/pages/tiger/skin_3.png", desc: "La tenue du Parrain du Tigre.", equipped: false },
    { id: "skin_cartoon", nom: "Tenue Dessin Animé", rarete: "Commun", img: "../src/assets/pages/tiger/skin_4.png", desc: "La tenue du Tigre version dessin animé.", equipped: false }
];