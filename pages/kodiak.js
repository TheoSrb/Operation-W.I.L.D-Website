const ENTITY_ID = "kodiak";

const ANIMAL_TAMING_EXP = 180.0;
const MAX_HEALTH = 45;
const DAMAGES = 9;
const KNOCKBACK_RESISTANCE = 0.7;
const SPEED = 7.75;

const ARCHETYPE = "BERSERKER";
const REGIME = "Omnivore";

const ANIMAL_PAGE_AVG_COLOR = "#714f3b";

const HERO_WALLPAPER = "../src/assets/animals_wallpapers/Kodiak-Wallpaper.png";
const HERO_WALLPAPER_OFFSET_Y = 20;
const PORTRAITS = [
    "../src/assets/pages/kodiak/kodiak_0.png",
    "../src/assets/pages/kodiak/kodiak_1.png",
    "../src/assets/pages/kodiak/kodiak_2.png"
];
const DIFFICULTY_ICON = "../src/assets/pages/difficulty-icon/difficulty_3.png";
...
const VARIANTS = [
    { img: "../src/assets/pages/kodiak/kodiak_0.png", nom: "Kodiak par Défaut", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "33%" },
    { img: "../src/assets/pages/kodiak/kodiak_1.png", nom: "Kodiak Noir", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "33%" },
    { img: "../src/assets/pages/kodiak/kodiak_2.png", nom: "Kodiak Gris", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "33%" }
];

const ANIMATIONS = [
    { label: "Idle", src: "../src/assets/pages/kodiak/anim_0.gif" },
    { label: "Marche", src: "../src/assets/pages/kodiak/anim_1.gif" },
    { label: "Course", src: "../src/assets/pages/kodiak/anim_2.gif" }
];
...
const SPAWN_RARITY_MAP = {
    "sequoia": "Peu Commun",
    "forest": "Rare"
};

const SIMILAR_ANIMALS = ["lion", "tiger", "crocodile"];
...
const COSMETICS = [
    { id: "skin_default", nom: "Tenue par Défaut", rarete: "Commun", img: "../src/assets/pages/kodiak/kodiak_0.png", desc: "La tenue de base du Kodiak.", equipped: true },
    { id: "skin_gold", nom: "Tenue Dorée", rarete: "Légendaire", img: "../src/assets/pages/kodiak/skin_0.png", desc: "La tenue dorée du Kodiak.", equipped: false },
    { id: "skin_skeleton", nom: "Tenue Squelettique", rarete: "Halloween", img: "../src/assets/pages/kodiak/skin_1.png", desc: "La tenue squelettique du Kodiak. <b>Exclusif à l'événement <span style='color: #ff9800;'>Operation Wildoween</span>.</b>", equipped: false },
    { id: "skin_shade", nom: "Tenue des Ombres", rarete: "Halloween", img: "../src/assets/pages/kodiak/skin_2.png", desc: "La tenue des ombres du Kodiak. <b>Exclusif à l'événement <span style='color: #ff9800;'>Operation Wildoween</span>.</b>", equipped: false }
];