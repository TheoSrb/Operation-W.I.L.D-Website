...
const ANIMAL_TAMING_EXP = 80.0;
const MAX_HEALTH = 25;
const DAMAGES = 2;
const KNOCKBACK_RESISTANCE = 0.3;
const SPEED = 4;

const ARCHETYPE = "MARAUDER";
const REGIME = "Carnivore";

const ANIMAL_PAGE_AVG_COLOR = "#656d29";

const HERO_WALLPAPER = "../src/assets/animals_wallpapers/Boa-Wallpaper.png";
const HERO_WALLPAPER_OFFSET_Y = 0;
const PORTRAITS = [
    "../src/assets/pages/boa/boa_0.png",
    "../src/assets/pages/boa/boa_1.png",
    "../src/assets/pages/boa/boa_2.png",
    "../src/assets/pages/boa/boa_3.png"
];
const DIFFICULTY_ICON = "../src/assets/pages/difficulty-icon/difficulty_1.png";
...
const VARIANTS = [
    { img: "../src/assets/pages/boa/boa_0.png", nom: "Boa par Défaut", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "25%" },
    { img: "../src/assets/pages/boa/boa_1.png", nom: "Boa Jaune", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "25%" },
    { img: "../src/assets/pages/boa/boa_2.png", nom: "Boa Marron", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "25%" },
    { img: "../src/assets/pages/boa/boa_3.png", nom: "Boa Sombre", badge: "Rare", badgeStyle: "background:rgba(58,122,180,.2);color:var(--blue2);border:1px solid rgba(58,122,180,.4)", taux: "25%" }
];

const ANIMATIONS = [
    { label: "Idle", src: "../src/assets/pages/boa/anim_0.gif" },
    { label: "Marche", src: "../src/assets/pages/boa/anim_1.gif" },
    { label: "Course", src: "../src/assets/pages/boa/anim_2.gif" }
];
...
const COSMETICS = [
    { id: "skin_default", nom: "Tenue par Défaut", rarete: "Commun", img: "../src/assets/pages/boa/boa_0.png", desc: "La tenue de base du Boa.", equipped: true },
    { id: "skin_gold", nom: "Tenue Dorée", rarete: "Légendaire", img: "../src/assets/pages/boa/skin_0.png", desc: "La tenue dorée du Boa.", equipped: false },
    { id: "skin_leviathan", nom: "Tenue Léviathan", rarete: "Légendaire", img: "../src/assets/pages/boa/skin_1.png", desc: "La tenue Léviathan du Boa.", equipped: false },
    { id: "skin_plush", nom: "Tenue Peluche", rarete: "Rare", img: "../src/assets/pages/boa/skin_2.png", desc: "La tenue Peluche du Boa.", equipped: false }
];